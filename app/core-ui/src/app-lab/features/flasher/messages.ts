...
export const messages = defineMessages({
  title: {
    id: 'app-lab.flash-board-dialog.flash-title',
    defaultMessage: 'Flash board',
    description: 'Title shown on the flash board dialog',
  },
  configurationStepTitle: {
    id: 'app-lab.flash-board-dialog.configuration-step-title',
  ...
  configurationStepPreserveDataWarning: {
    id: 'app-lab.flash-board-dialog.configuration-step-preserve-data-warning',
    defaultMessage:
  ...
  configurationStepAction: {
    id: 'app-lab.flash-board-dialog.configuration-step-action',
    defaultMessage: 'Start flashing',
    description: 'Action text for starting the flashing process',
  },
  configurationStepActionInfo: {
    id: 'app-lab.flash-board-dialog.configuration-step-action-label',
  ...
  configurationStepActionError: {
    id: 'app-lab.flash-board-dialog.configuration-step-action-error',
    defaultMessage: 'An error occurred, please try again.',
    description: 'Error message shown when flashing process fails',
  },
  configurationStepActionWarning: {
    id: 'app-lab.flash-board-dialog.configuration-step-action-warning',
    defaultMessage:
  ...
  preparationStepTitle: {
    id: 'app-lab.flash-board-dialog.preparation-step-title',
  ...
  preparationStepDescription: {
    id: 'app-lab.flash-board-dialog.preparation-step-description',
    defaultMessage:
  ...
  preparationStepInstruction1: {
    id: 'app-lab.flash-board-dialog.preparation-step-instruction-1',
  ...
  preparationStepInstruction1Alternative: {
    id: 'app-lab.flash-board-dialog.preparation-step-instruction-1-alternative',
    defaultMessage:
  ...
  preparationStepInstruction2: {
    id: 'app-lab.flash-board-dialog.preparation-step-instruction-2',
    defaultMessage:
  ...
  preparationStepInstruction2TooltipTitle: {
    id: 'app-lab.flash-board-dialog.preparation-step-instruction-2-tooltip-title',
  ...
  preparationStepInstruction2TooltipContent: {
    id: 'app-lab.flash-board-dialog.preparation-step-instruction-2-tooltip-content',
    defaultMessage:
  ...
  preparationStepInstruction3: {
    id: 'app-lab.flash-board-dialog.preparation-step-instruction-3',
    defaultMessage:
  ...
  flashingStepFlashingWaitingLabel: {
    id: 'app-lab.flash-board-dialog.flashing-step-flashing-waiting-label',
  ...
  flashingStepSucceededInstruction1: {
    id: 'app-lab.flash-board-dialog.flashing-step-succeeded-instruction-1',
  ...
  flashingStepSucceededInstruction2: {
    id: 'app-lab.flash-board-dialog.flashing-step-succeeded-instruction-2',
  ...
  flashingStepSucceededInstruction3: {
    id: 'app-lab.flash-board-dialog.flashing-step-succeeded-instruction-3',
  ...
  flashingStepSucceededDescription: {
    id: 'app-lab.flash-board-dialog.flashing-step-succeeded-description',
    defaultMessage:
  ...
  flashingStepSucceededDoneButton: {
    id: 'app-lab.flash-board-dialog.flashing-step-succeeded-done-button',
    defaultMessage: 'Ok, done',
    description: 'Button label to close flashing after success',
  },
  flashingStepFailedDescription1: {
    id: 'app-lab.flash-board-dialog.flashing-step-failed-description-1',
  ...
  flashingStepFailedDescription2: {
    id: 'app-lab.flash-board-dialog.flashing-step-failed-description-2',
    defaultMessage:
      'Try again — and if it keeps happening, you can reach out to <link>Support.</link>',
    description: 'Description shown when the flashing process has failed',
  },
  flashingStepFailedRetryButton: {
    id: 'app-lab.flash-board-dialog.flashing-step-failed-retry-button',
    defaultMessage: 'Retry',
    description: 'Button label to retry flashing after failure',
  },
  error: {
    id: 'app-lab.flash-board-dialog.generic-error',
    defaultMessage: 'Unknown error while flashing the board. Please try again.',
    description: 'Generic error message shown in the flash board dialog',
  },
});
